...
def lovasz_projection_continuous_descending_sampler(f: Objective, rng: np.random.Generator,
    ...
    it: Iterator[Set[int]] = itertools.islice(
        lovasz_projection_continuous_descending_inner(f=f, rng=rng, M=M + n_burn_in, std=std),
        n_burn_in,
        None)

    # chronological history of Lovasz-Projection samples
    lovasz_projection_continuous_descending_history = list(it)

    # aggregate the Lovasz-Projection samples
    lovasz_projection_continuous_descending_samples_f = Counter((frozenset(X) for X in lovasz_projection_continuous_descending_history))
    return lovasz_projection_continuous_descending_samples_f, lovasz_projection_continuous_descending_history


def lovasz_projection_continuous_descending_inner(f: Objective, rng: np.random.Generator,
